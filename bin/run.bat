...
if %processor_architecture%==x86 (
	"%SCRIPTPATH%\bin\leanote-windows-386.exe" -importPath github.com/htmambo/leanote
) else (
	"%SCRIPTPATH%\bin\leanote-windows-amd64.exe" -importPath github.com/htmambo/leanote
)
